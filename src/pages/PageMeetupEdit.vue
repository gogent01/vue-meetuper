    ...
    <section class="hero">
      <div class="hero-body">
        ...
        <div class="is-pulled-right">
          <!-- Update Button -->
          <button class="button is-success is-large" @click="updateMeetup">Update</button>
        </div>
      </div>
    </section>
...
<script>
  ...
  export default {
    ...
    created () {
      this.fetchMeetupByIdHandler()
        .then(() => {
          ...
          this.meetupCreator = meetup.meetupCreator;
        });
    ...
    methods: {
      ...
      updateMeetup () {
        const timeFrom = this.deParseTime(this.meetup.timeFrom);
        const timeTo = this.deParseTime(this.meetup.timeTo);
        const meetupData = {...this.meetup, timeFrom, timeTo};

        this.$store.dispatch('meetups/updateMeetup', meetupData)
          .then(() => {
