            ...
            <form>
              ...
              <div class="field">
                <div class="control">
                  ...
                  <span v-if="!$v.form.avatar.supportedFileType" class="help is-danger">Selected image type is not valid</span>
                </div>
              </div>
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.password.$error" class="form-error">
                    ...
                    <span v-if="!$v.form.password.minLength" class="help is-danger">Password minimum length should be at least 8 characters</span>
                  </div>
                </div>
              </div>
              <div class="field">
                <div class="control">
                  <input v-model="form.passwordConformation"
                  ...
                  <div v-if="$v.form.passwordConformation.$error" class="form-error">
                    <span v-if="!$v.form.passwordConformation.required" class="help is-danger">Password conformation is required</span>
                    <span v-if="!$v.form.passwordConformation.sameAs" class="help is-danger">Password conformation does not match the password</span>
                  </div>
                </div>
              </div>
